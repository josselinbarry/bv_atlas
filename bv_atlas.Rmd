...
Le réseau hydrographique breton issu de la BD Topage couvre un linéaire de 47804 km.

La distribution de ces tronçons selon l’ordination de Strahler est la suivante :
```{r}
lineaire_topage_rang
```
Si l'on écarte les tronçons indiqués comme "intermittent", ce linéaire est de 21567 km, qui se distribue selon l’ordination de Strahler de la manière suivante :
```{r}
...
Si l'on considère le réseau hydrographique complet, la surface moyenne de ces 1751 bassins versants est de 1705 ha, pour une surface médiane de 70 ha.
